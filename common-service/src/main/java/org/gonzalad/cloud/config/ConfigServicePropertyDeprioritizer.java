package org.gonzalad.cloud.config;
...
// from http://stackoverflow.com/questions/31551039/override-spring-cloud-config-values-with-environment
@Component
@Order(Ordered.HIGHEST_PRECEDENCE)
public class ConfigServicePropertyDeprioritizer
        implements ApplicationListener<ApplicationPreparedEvent>
{
    private static final String CONFIG_SOURCE = "bootstrapProperties";//"bootstrap";

    private static final String PRIORITY_SOURCE = "systemProperties";//"systemEnvironment";
